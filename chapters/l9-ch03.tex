...
\hline
\textbf{\hebheader{תצפית}} & \textbf{\hebheader{$y_i$ (אמיתי)}} & \textbf{\hebheader{$\hat{y}_i$ (חזוי)}} & \textbf{\hebheader{$(y_i - \bar{y})^2$}} & \textbf{\hebheader{$(y_i - \hat{y}_i)^2$}} \\
\hline
\encell{\num{1}} & \encell{\num{600000}} & \encell{\num{580000}} & \encell{\num{10000000000}} & \encell{\num{400000000}} \\
\hline
\encell{\num{2}} & \encell{\num{450000}} & \encell{\num{470000}} & \encell{\num{2500000000}} & \encell{\num{400000000}} \\
\hline
\encell{\num{3}} & \encell{\num{700000}} & \encell{\num{680000}} & \encell{\num{40000000000}} & \encell{\num{400000000}} \\
\hline
\textbf{\hebheader{סה"כ}} & & & \mixedcell{$SS_{\text{tot}} = \num{52500000000}$} & \mixedcell{$SS_{\text{res}} = \num{1200000000}$} \\
\hline
\end{rtltabular}
\end{hebrewtable}
...
\hline
\textbf{\hebheader{מספר תכונות}} & \textbf{\hebheader{\Rsquared{} (אימון)}} \\
\hline
\encell{\num{1}} & \encell{\num{0.850}} \\
\hline
\encell{\num{2}} & \encell{\num{0.852}} \\
...
\hline
\textbf{\hebheader{תכונות}} & \textbf{\hebheader{\Rsquared{}}} & \textbf{\enheader{Adjusted \Rsquared{}}} \\
\hline
\encell{\num{1}} & \encell{\num{0.850}} & \encell{\num{0.849}} \\
\hline
\encell{\num{2}} & \encell{\num{0.852}} & \encell{\num{0.849}} \\
...
\hline
\textbf{\hebheader{משימה}} & \textbf{\hebheader{מדד}} & \textbf{\hebheader{הסבר}} \\
\hline
\hebcell{רגרסיה} & \encell{\Rsquared{}, RMSE, MAE} & \hebcell{\Rsquared{} מודד שיעור שונות מוסברת} \\
\hline
\hebcell{סיווג} & \mixedcell{Accuracy, Precision, Recall, F1} & \hebcell{מודדים אחוז סיווגים נכונים} \\
\hline
\hebcell{סיווג (התפלגות)} & \encell{Log-Loss, AUC-ROC} & \hebcell{מודדים איכות הסתברויות} \\
\hline
\end{rtltabular}
\end{hebrewtable}
