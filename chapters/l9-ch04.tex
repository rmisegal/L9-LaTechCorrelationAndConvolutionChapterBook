...
\hline
\textbf{\hebheader{ערך}} & \textbf{\hebheader{משמעות}} \\
\hline
\mixedcell{$\text{Cov}(X,Y) > 0$} & \hebcell{קשר חיובי: כאשר $X$ גדל, $Y$ נוטה לגדול} \\
\hline
\mixedcell{$\text{Cov}(X,Y) = 0$} & \hebcell{אין קשר ליניארי (לא בהכרח בלתי תלויים!)} \\
\hline
\mixedcell{$\text{Cov}(X,Y) < 0$} & \hebcell{קשר שלילי: כאשר $X$ גדל, $Y$ נוטה לקטון} \\
\hline
\end{rtltabular}
\end{hebrewtable}
...
\hline
\textbf{\hebheader{אדם}} & \textbf{\hebheader{גובה (ס"מ)}} & \textbf{\hebheader{משקל (ק"ג)}} \\
\hline
\encell{\num{1}} & \encell{\num{160}} & \encell{\num{55}} \\
\hline
\encell{\num{2}} & \encell{\num{170}} & \encell{\num{65}} \\
...
\hline
\textbf{\hebheader{משתנה \en{X}}} & \textbf{\hebheader{משתנה \en{Y}}} & \textbf{\hebheader{משתנה מבלבל \en{Z}}} \\
\hline
...
\hline
\mixedcell{מכירות Nicolas Cage} & \hebcell{טביעות בבריכות} & \hebcell{מקריות סטטיסטית} \\
\hline
\end{rtltabular}
\end{hebrewtable}
...
\hline
\textbf{\hebheader{קריטריון}} & \textbf{\hebheader{הסבר}} \\
\hline
...
\hline
\textbf{\hebheader{מה הוא מודד}} & \textbf{\hebheader{סוג}} & \textbf{\hebheader{מדד}} \\
\hline
\hebcell{קשר ליניארי בלבד} & \hebcell{פרמטרי} & \hebcell{קורלציה של פירסון} \\
\hline
\hebcell{קשר מונוטוני (לא בהכרח ליניארי)} & \hebcell{לא-פרמטרי} & \hebcell{קורלציה של ספירמן} \\
\hline
\hebcell{קשר מונוטוני (עמיד יותר ל\en{-}outliers)} & \hebcell{לא-פרמטרי} & \hebcell{קורלציה של קנדל} \\
\hline
\hebcell{כל סוג תלות (כולל לא-מונוטונית)} & \hebcell{לא-פרמטרי} & \hebcell{\en{Distance Correlation}} \\
\hline
\hebcell{כל סוג תלות (גם לא-דטרמיניסטית)} & \hebcell{תאוריית מידע} & \hebcell{\en{Mutual Information}} \\
\hline
\end{rtltabular}
\end{hebrewtable}
