...
\hline
\textbf{\hebcell{שגיאה}} & \textbf{\hebcell{\en{MAE} ($|e|$)}} & \textbf{\hebcell{\en{MSE} ($e^2$)}} \\
\hline
\num{1} & \num{1} & \num{1} \\
\hline
\num{2} & \num{2} & \num{4} \\
...
\hline
\textbf{\hebcell{פונקציה}} & \textbf{\hebcell{נגזרת חלקית לפי \en{x}}} \\
\hline
...
\hline
\textbf{\hebcell{\en{Learning Rate}}} & \textbf{\hebcell{התנהגות}} \\
\hline
\hebcell{קטן מדי ($\alpha = 10^{-6}$)} & \hebcell{התכנסות איטית מאוד, דורש אלפי איטרציות} \\
\hline
\hebcell{אופטימלי ($\alpha = 10^{-2}$)} & \hebcell{התכנסות מהירה ויציבה} \\
\hline
\hebcell{גדול מדי ($\alpha = 10^{1}$)} & \hebcell{קפיצות, חוסר התכנסות, פיצוץ לאינסוף} \\
\hline
\end{rtltabular}
\end{hebrewtable}
...
\hline
\textbf{\hebcell{שיטה}} & \textbf{\hebcell{\en{Batch Size}}} & \textbf{\hebcell{יתרונות}} & \textbf{\hebcell{חסרונות}} \\
\hline
\hebcell{\en{Batch GD}} & $n$ & \hebcell{יציב, מדויק} & \hebcell{איטי, דורש זיכרון רב} \\
\hline
\hebcell{\en{SGD}} & \num{1} & \hebcell{מהיר מאוד} & \hebcell{רועש, לא מתכנס למדויק} \\
\hline
\hebcell{\en{Mini-Batch}} & \num{32-256} & \hebcell{איזון טוב} & \hebcell{צריך לכוונן גודל} \\
\hline
\end{rtltabular}
\end{hebrewtable}
...
\hline
\textbf{\hebcell{שיטה}} & \textbf{\hebcell{$d=10$}} & \textbf{\hebcell{$d=100$}} & \textbf{\hebcell{$d=500$}} \\
\hline
\hebcell{\en{Normal Eq}} & \num{0.001}s & \num{0.01}s & \num{0.5}s \\
\hline
\hebcell{\en{GD (1000 iter)}} & \num{0.02}s & \num{0.2}s & \num{1.0}s \\
\hline
\hebcell{\en{sklearn}} & \num{0.001}s & \num{0.008}s & \num{0.3}s \\
\hline
\end{rtltabular}
