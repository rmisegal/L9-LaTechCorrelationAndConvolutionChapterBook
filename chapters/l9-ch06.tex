...
\hline
\textbf{\hebheader{בעיה}} & \textbf{\hebheader{חיזוי ליניארי}} & \textbf{\hebheader{שעות לימוד}} \\
\hline
\hebcell{הסתברות שלילית?!} & \encell{\num{-0.5}} & \encell{\num{1}} \\
\hline
\hebcell{סביר} & \encell{\num{0.3}} & \encell{\num{3}} \\
\hline
\hebcell{סביר} & \encell{\num{0.7}} & \encell{\num{5}} \\
...
\hline
\textbf{\hebheader{החלטה}} & \textbf{\hebheader{\en{σ(z)}}} & \textbf{\hebheader{\en{z}}} & \textbf{\hebheader{שעות}} \\
\hline
\hebcell{נכשל} & \encell{\num{0.018}} & \encell{$-4$} & \encell{\num{1}} \\
\hline
\hebcell{נכשל} & \encell{\num{0.119}} & \encell{$-2$} & \encell{\num{3}} \\
\hline
\hebcell{על הגבול} & \encell{\num{0.500}} & \encell{$0$} & \encell{\num{5}} \\
\hline
\hebcell{עבר} & \encell{\num{0.881}} & \encell{$2$} & \encell{\num{7}} \\
\hline
\hebcell{עבר (בטוח)} & \encell{\num{0.993}} & \encell{$5$} & \encell{\num{10}} \\
\hline
\end{rtltabular}
\end{hebrewtable}
...
\hline
\textbf{\hebheader{חזוי: \num{1}}} & \textbf{\hebheader{חזוי: \num{0}}} & \\
\hline
\hebcell{\en{True Positive (TP)}} & \hebcell{\en{False Negative (FN)}} & \textbf{\hebcell{אמיתי: \num{1}}} \\
\hline
\hebcell{\en{False Positive (FP)}} & \hebcell{\en{True Negative (TN)}} & \textbf{\hebcell{אמיתי: \num{0}}} \\
\hline
\end{rtltabular}
\end{hebrewtable}
...
\hline
\textbf{\hebheader{חזוי: חולה}} & \textbf{\hebheader{חזוי: בריא}} & \\
\hline
\encell{\num{3}} & \encell{\num{2}} & \textbf{\hebcell{אמיתי: חולה}} \\
\hline
\encell{\num{1}} & \encell{\num{94}} & \textbf{\hebcell{אמיתי: בריא}} \\
\hline
\end{rtltabular}
\end{hebrewtable}
